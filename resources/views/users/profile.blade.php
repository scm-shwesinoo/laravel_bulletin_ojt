          ...
          <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-6 text-center d-flex flex-column align-items-center">
              <div class="row img-blk position-relative mb-3">
                <div class="profile">
                  <img class="preview-profile w-100" src="{{ asset('storage/images/'.$user->profile) }}" />
                </div>
                <a type="button" class="btn btn-primary rounded-circle w-auto position-absolute edit-btn"
