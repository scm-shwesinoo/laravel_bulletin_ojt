                    ...
                    <div class="card-body">
                        <div class="row mb-2 search-bar">
                            <form action="{{ route('userlist') }}" method="GET" class="d-flex justify-content-end">
                                ...
                                <input class="form-control search-input mb-2 mx-2 w-auto" type="text" name="search_name"
                                    id="search-name" />
                                <label class="p-2 search-lbl w-auto">Email :</label>
                                <input class="form-control search-input mb-2 mx-2 w-auto" type="text" name="search_email"
                                    id="search-email" />
                                <label class="p-2 search-lbl w-auto">From :</label>
                                <input class="form-control search-input mb-2 mx-2 w-auto" name="date_start" id="dateStart"
                                    type="date" />
                                <label class="p-2 search-lbl w-auto">To :</label>
                                <input class="form-control search-input mb-2 mx-2 w-auto" name="date_end" id="dateEnd"
                                    type="date" />
                                <button class="btn btn-primary mb-2 mx-2 w-auto search-btn"
                                    id="search-click">Search</button>
                            </form>
                        </div>
                        <form action="" method="get" class="mb-3">
                            <label for="page_size">Page Size:</label>
                            <select class="form-select d-inline w-auto" name="page_size" id="user_page_size">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="user-name"
                                                    onclick="User.prototype.showUserDetail({{ $user }}, {{ $user->createdBy }}, {{ $user->updatedBy }})"
                                            ...
                                            <td>
                                                @if ($user->id != auth()->user()->id)
                                                    <button type="button" class="btn btn-danger"
                                                        onclick="User.prototype.showDeleteConfirm({{ $user }})"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#user-delete-modal">Delete</button>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
                                        ...
                                        <div class="modal-body" id="user-detail">
                                            <div class="row">
                                                <div class="col-lg-3 col-md-12 col-sm-6 text-center">
                                                    <img id="user-profile" class="preview-profile w-100" src=""
                                                        alt="Profile" />
                                                </div>
                                                <div class="col-lg-9 col-md-12 col-sm-6">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <label class="col-md-8 text-start">
                                                            <i class="profile-text"
                                                                id="user-type">{{ $user->type == 0 ? 'Admin' : 'User' }}</i>
                                                        </label>
                                                    </div>
                                                    <div class="row mb-3">
                                                    ...
                                                    <div class="row mb-3">
                                                        <label
                                                            class="col-md-4 text-start">{{ __('Date of Birth') }}</label>
                                                        <label class="col-md-8 text-start">
                                                    ...
                                                    <div class="row mb-3">
                                                        <label
                                                            class="col-md-4 text-start">{{ __('Created Date') }}</label>
                                                        <label class="col-md-8 text-start">
                                                    ...
                                                    <div class="row mb-3">
                                                        <label
                                                            class="col-md-4 text-start">{{ __('Created User') }}</label>
                                                        <label class="col-md-8 text-start">
                                                    ...
                                                    <div class="row mb-3">
                                                        <label
                                                            class="col-md-4 text-start">{{ __('Updated Date') }}</label>
                                                        <label class="col-md-8 text-start">
                                                    ...
                                                    <div class="row mb-3">
                                                        <label
                                                            class="col-md-4 text-start">{{ __('Updated User') }}</label>
                                                        <label class="col-md-8 text-start">
