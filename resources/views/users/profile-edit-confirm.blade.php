                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('profile.edit.confirm') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" name="name"
                                        value="{{ old('name') }}" autocomplete="name" readonly="readonly">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control" name="email"
                                        value="{{ old('email') }}" readonly="readonly">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control @error('type') is-invalid @enderror hide-input"
                                        name="type" readonly="readonly">
                                        <option value="{{ old('type') }}" selected>{{ old('type') == 0 ? 'Admin' : 'User' }}
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="text" class="form-control" name="phone"
                                        value="{{ old('phone') }}" readonly="readonly">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="dob" type="date" class="form-control" name="dob"
                                        value="{{ old('dob') }}" readonly="readonly">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="profile" type="text" class="form-control hide-input mb-3" name="profile"
                                        required value="{{ session('profileName') }}" autocomplete="profile"
                                        readonly="readonly" />
                                    <img class="preview-profile w-50"
                                        src="{{ asset('storage/images/' . session('profileName')) }}" />
                                </div>
                            </div>
