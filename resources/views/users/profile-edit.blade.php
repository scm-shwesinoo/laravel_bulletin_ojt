      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('profile.edit') }}" enctype="multipart/form-data">
            ...
            <div class="form-group row mb-3">
              <label for="email" class="col-md-4 col-form-label text-md-end required">{{ __('E-Mail Address') }}</label>
              <div class="col-md-6">
            ...
            <div class="form-group row mb-3">
              <label for="type" class="col-md-4 col-form-label text-md-end required" id="type">{{ __('Type') }}</label>
              <div class="col-md-6">
                @if(Auth::user()->type == '0')
                <select class="form-select @error('type') is-invalid @enderror" name="type">
                  <option value="0" {{ $user->type == 0 ?'selected': '' }}>{{ __('Admin') }}</option>
            ...
            <div class="form-group row mb-3">
              <label for="old-profile" class="col-md-4 col-form-label text-md-end">{{ __('Old Profile') }}</label>
              <div class="col-md-6">
                <img class="preview-profile w-50" src="{{ asset('storage/images/'.$user->profile) }}" />
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-6">
                <input id="profile" type="file" class="profile form-control @error('profile') is-invalid @enderror"
                  name="profile" autocomplete="profile" />
                @error('profile')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
