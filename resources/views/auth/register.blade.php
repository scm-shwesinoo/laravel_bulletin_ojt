                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="form-group row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-end required">{{ __('Name') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-end required">{{ __('E-Mail Address') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-end required">{{ __('Password') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-end required">{{ __('Confirm Password') }}</label>
                        ...
                        <div class="form-group row mb-3">
                            <label for="type" class="col-md-4 col-form-label text-end required">{{ __('Type') }}</label>
                        ...
                        <div class="form-group row mb-3">
                            <label class="col-md-4 col-form-label text-end required">{{ __('Profile') }}</label>
                            <div class="col-md-6">
