$(document).ready(function () {
    ...
    $('#user_page_size').on('change', function () {
...
export class User {
    ...
    showUserDetail(userInfo, createdBy, updatedBy) {
        ...
        $("#user-detail #user-created-user").text(createdBy.name ? createdBy.name : '');
        $("#user-detail #user-updated-at").text(
            moment(userInfo.updated_at).format("YYYY/MM/DD")
        );
        $("#user-detail #user-updated-user").text(updatedBy.name ? updatedBy.name : '');
    }
