$(document).ready(function () {
  ...
  $('#post_page_size').on('change', function () {
    console.log('hello');
...
export class Post {
  ...
  showPostDetail(postInfo, createdBy, updatedBy) {
    ...
    $("#post-detail #post-created-user").text(createdBy.name);
    $("#post-detail #post-updated-at").text(
      moment(postInfo.updated_at).format("YYYY/MM/DD")
    );
    $("#post-detail #post-updated-user").text(updatedBy.name);
  }

  showDeleteConfirm(postInfo) {
